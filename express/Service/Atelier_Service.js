    ...
    Reparations.count({
        ...
        Reparations.count({
            ...
            if (nbFini == nbReparation) {
                 ...
                 */
                SendMail(Fiche_.user.mail, "Reparation terminée", "Bonjour!! \n La réparation de votre voiture est terminée,\nveuillez payer la facture svp.")
            }
        })
    })
}
...
const ValiderSortie = async (req, res) => {
    ...
    if (fiche.length == 0) {
        ...
        let resultat = {
            valide: "Le bon de sortie est validé."
        }
        return sendResult(res, resultat);
    }
